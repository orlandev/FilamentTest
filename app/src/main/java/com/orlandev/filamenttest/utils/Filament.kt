...
package com.orlandev.filamenttest.utils
...
import com.orlandev.filamenttest.ModelViewer
import java.nio.Buffer
import java.nio.ByteBuffer

data class DataScene(val engine: Engine, val scene: Scene, val asset: FilamentAsset)

val scenes = mutableMapOf<String, DataScene>()
